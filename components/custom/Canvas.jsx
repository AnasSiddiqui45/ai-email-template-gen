    ...
    <div className='mt-20 flex justify-center'>
      ...
      >
        {emailTemplate?.length > 0 ? emailTemplate?.map((layout, index) => (
          ...
          <h2 className='p-4 text-center bg-gray-200 border border-dashed'>Add Layout Here</h2>
        }

      </div>
      <ViewHtmlDialog openDialog={viewHTMLCode} 
      htmlCode={htmlCode} closeDialog={closeDialog}/>
    </div>
  )
}
